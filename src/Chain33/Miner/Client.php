...
class Client extends BaseClient
{
     ...
     * @return string         返回挖矿地址
     */
    public function addr(string $addr): string
    {
     ...
     * @return array          冷钱包地址列表
     */
    public function source(string $addr): array
    {
        return $this->client->Query([
            'execer'   => 'ticket',
